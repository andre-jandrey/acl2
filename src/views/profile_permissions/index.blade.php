    ...
    <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Permissões por perfil
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <table class="table table-striped table-bordered " style="" id="table_profile_permissions">
                            <thead>
                                <tr class="">                               
                                    <th>Permissão</th>
                                    <th>Perfil</th>
                            ...
                            <tbody>
                                @foreach ($profile_permissions as $c)
                                    <tr>
                                        <td>{{ $c->permission->name }}</td>
                                        <td>{{ $c->profile->name }}</td>
                                        {{-- <td width='100px'> 
                                             <a href="{{ route('profile_permissions.edit', $c->profile->id) }}" title="Editar" class="btn btn-sm btn-primary  edit">
...
@section('js')  
    ...
    $(document).ready(function(){
        ...
        $('#table_profile_permissions').DataTable();        
    });
    var deleteFormAction;
    $('td').on('click', '.delete', function (e) {
        $('#delete_form')[0].action = 'profile_permissions/__id'.replace('__id', $(this).data('id'));
