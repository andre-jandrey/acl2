            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <table class="table table-striped table-bordered " style="" id="table_user_profiles">
                            <thead>
                                <tr class="">
                                    <th>Usuário</th>
                                    <th>Perfil</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        <a href="{{ route('user_profiles.edit', $uprofiles->user->id) }}"
                                    title="Editar"
                                    ...
                                    <a href="javascript:;" title="Remover" class="btn btn-sm btn-danger  delete"
                                        data-id="{{ $uprofiles->id}}" id="delete-2">
...
<script>
    $(document).ready(function () {
        ...
        $('#table_user_profiles').DataTable();
    });
    var deleteFormAction;
    $('td').on('click', '.delete', function (e) {
        $('#delete_form')[0].action = 'user_profiles/__id'.replace('__id', $(this).data('id'));
